#' Plotting for state-trait ordinal regression fitted values
#' 
#' Plots fitted values for the various state-trait combinations for a \code{\link{store}} fit.
#' 
...
#' @param range Scaling values (in [0,25])
...
#' @importFrom ggplot2 ggplot geom_point scale_colour_gradientn scale_size 
#' @importFrom ggplot2 theme labs theme_bw element_text aes 
#' @importFrom latex2exp TeX
#' @importFrom stringr str_to_title
#' @export
fitplot <-
  function(obj, col=NULL, bubble=FALSE,
           xlab="State",ylab="Person-specific median", title=NULL, 
