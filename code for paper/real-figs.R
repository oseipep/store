# Producing the tables and figures 
require(store)
source("utils.R")
...
# Motivating data set: cross tabulation pleasant vs stressed
...
# Figure 1: Pleasant thoughts on exhaustion  
# unpenalized and penalized of pleasant on exhausted store objects
# read from source
...
# Figure 6  
# Read store fits for the 5 variables from source:
